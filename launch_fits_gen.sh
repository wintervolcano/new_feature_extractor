...
singularity exec -H /u/dbhatnagar:/home1 -B ~/.Xauthority -B $sing_img python3 FITS_generator_for_pfd.py --config "$config" --pfd $pfd_file --output $output
