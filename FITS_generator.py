...
class FITSGen:
    ...
    def __init__(self, config_path, ar_file_path, output_file_path): #, verbose=False):
...
def main():
    ...
    generator = FITSGen(args.config,args.ar,args.output) #,args.v)
    generator.write_fits()
    print(f"Succesful! Processed file: {args.ar}")
