...
singularity exec -H /u/fkareem/ -B ~/.Xauthority -B $sing_img_ar python3 /hercules/results/fkareem/FeatureExtractor/FITS_Generator_patch.py --config "$config" --ar $ar_file --output $output
